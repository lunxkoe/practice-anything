package lunxkoe.practice.global.temppassword.properties;

import jakarta.validation.constraints.NotNull;
import java.time.Duration;
import lunxkoe.practice.global.temppassword.properties.enums.TempPasswordGeneratorType;
import lunxkoe.practice.global.temppassword.properties.enums.TempPasswordRegistryType;
import org.hibernate.validator.constraints.time.DurationMin;
import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.validation.annotation.Validated;

@Validated
@ConfigurationProperties(prefix = "app.temp-password")
